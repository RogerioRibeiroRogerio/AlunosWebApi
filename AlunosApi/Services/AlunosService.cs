...
{
    public class AlunosService : InterfaceAlunoService
    {
        ...
        public async Task<IEnumerable<Aluno>> GetAlunos()
        {
            try
            {
                ...
                /*return await _context.Alunos.AsNoTracking().ToListAsync();
                 se não precisar de fazer alterações posso usar o metodo "AsNoTracking()" pois nao vai rastrear as entidades*/ 
            }
            catch 
            {
